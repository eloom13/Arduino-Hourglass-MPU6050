...
// Rotary Encoder
#define PIN_ENC_1 3 // A
#define PIN_ENC_2 2 // B
#define PIN_ENC_BUTTON 7 // S
...
int drop_time = 300; //in ms - will be changed to 1000 after manual setting minutes/hours with rotary-encoder
...
void alarm() {
  ...
  // 3 buzzer-sequences when Minute/Hour was set by rotary-encoder
  else if(drop_time == 1000){
    for (int k=0; k<3; k++) {  
      for (int i=0; i<3; i++) {
      delay(100);
      digitalWrite(PIN_BUZZER, HIGH);    
